      ...
      <div className="grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 place-items-start gap-8 text-white">
        <div>
          ...
          <p className="text-sm leading-7">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam amet dolor eligendi suscipit laboriosam quas beatae non asperiores quod consectetur?
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <a href="" className='text-sm hover:underline '>Terms & C  onditions</a>
          </div>
        </div>
        <div>
        <div className='font-bold mb-6'>Follow us</div>
        <div className="text-sm mb-4">skillexlearing@gmail.com</div>
        <div className="text-sm">+959374375864 </div>
